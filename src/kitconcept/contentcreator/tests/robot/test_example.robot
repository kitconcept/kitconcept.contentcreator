...
#
#  $ bin/test -s kitconcept.contentcreator -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src kitconcept.contentcreator.testing.Contentcreator_CORE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/kitconcept/contentcreator/core/tests/robot/test_example.robot
#
